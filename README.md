# Magen Phone v4.7.1 — Audited HTTPS Inspection + One-shot Short-form Auto Skip (8443)


## v4.7.1: HTTPS Inspection + Short-form Auto Skip
...
- Known and heuristically detected login/payment/banking/health/password-manager hosts are conservatively tunneled end-to-end; the signer applies the same deny policy as defense-in-depth.
