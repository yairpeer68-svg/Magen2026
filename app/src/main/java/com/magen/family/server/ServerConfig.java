...
public final class ServerConfig {
    ...
    private static final String K_TRUST_SCORE="trust_score";
    ...
    public static int trustScore(Context c){ return p(c).getInt(K_TRUST_SCORE,-1); }
    public static void setTrustScore(Context c,int score){ p(c).edit().putInt(K_TRUST_SCORE,Math.max(0,Math.min(100,score))).apply(); }
