    ...
    public static boolean sendBlocking(Context c){
        ...
        try{
            ...
            JSONObject b=new JSONObject()
                ...
                .put("hardware_key_backed",DeviceIdentity.isHardwareBacked())
                .put("strongbox_backed",DeviceIdentity.isStrongBoxBacked())
                .put("root_suspected",com.magen.family.service.IntegrityGuard.isDeviceRooted())
                .put("signature_tampered",com.magen.family.service.IntegrityGuard.isSignatureTampered(c))
                .put("permission_core_ready",com.magen.family.util.PermissionMatrix.coreReady(c))
