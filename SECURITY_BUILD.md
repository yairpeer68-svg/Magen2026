# Secure build — Magen Phone v4.7.1 Audited HTTPS Inspection + Short-form Auto Skip
...
- Visual model trust is SHA-256 pinned; first bootstrap requires a GitHub-published asset digest or an independently supplied MAGEN_VISUAL_MODEL_SHA256, then the lock is committed.
